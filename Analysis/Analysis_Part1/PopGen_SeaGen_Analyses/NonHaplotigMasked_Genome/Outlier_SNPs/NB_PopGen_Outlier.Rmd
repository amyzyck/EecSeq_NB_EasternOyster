---
title: "NB Population Genomic Analysis on Non-Haplotig Masked Outlier SNPs"
author: "Amy Zyck"
date: "7/6/2020"
output:
...
I first created a new directory `NB_PopGen_Outlier` within `PATH: /home/azyck/NB_capture/NB_ddocent`. I linked `outlierloci.recode.vcf` to this working directory. The RMarkdown file should be saved in this same working directory. 
...
RDA and pRDA output plots can be viewed [here](https://github.com/amyzyck/EecSeq_NB_EasternOyster/tree/master/Output/RedundancyAnalysis/NonHapMasked_Outlier).